...
namespace ET {
  ...
  #region Messages
  public partial class C2L_Login : pb::IMessage {
    private static readonly pb::MessageParser<C2L_Login> _parser = new pb::MessageParser<C2L_Login>(() => (C2L_Login)MessagePool.Instance.Fetch(typeof(C2L_Login)));
  ...
  public partial class L2C_Login : pb::IMessage {
    private static readonly pb::MessageParser<L2C_Login> _parser = new pb::MessageParser<L2C_Login>(() => (L2C_Login)MessagePool.Instance.Fetch(typeof(L2C_Login)));
